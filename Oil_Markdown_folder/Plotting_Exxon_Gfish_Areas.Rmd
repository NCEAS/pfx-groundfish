...
ak_areas_all <- akmap2 +
                geom_point(data=discrete_areas_combo, 
                           aes(LONGITUDE, LATITUDE, color=Area_Combo1,
                               fill=Area_Combo1)) + 
                 scale_color_manual(values=Colors1, name="Study Area", guide=FALSE) +
                 scale_fill_manual(values=Colors1, name="Study Area", guide=FALSE) +
                 ...
                 annotate("text", x=-152, y=57.25, label="7", size=4, color="white") +
                 annotate("text", x=-155.5, y=56.45, label="8", size=4, color="white") +
                 annotate("text", x=-157.25, y=55.75, label="9", size=4, color="white") +
                 annotate("text", x=-149.25, y=58.9, label="10", size=4) +
...
ak_so <- ak_areas_all + 
         ...
         annotate("text", x=-163, y=61.4, label="N", size=6) +

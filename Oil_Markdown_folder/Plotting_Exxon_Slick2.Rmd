...
```{r, include=FALSE, echo=FALSE}
### Eventually make this download from online source!!
slk3_shp <- readOGR(dsn="../Oil_Markdown_folder", layer="ExxonSlick2", stringsAsFactors=FALSE)
crs(slk3_shp)
...
```{r}
### Eventually make this download from online source!!
slk_sss <- readOGR(dsn=path.expand("../Oil Markdown folder"),
                   layer="EVOSShorelineSubSurfaceOilingLine",
                   stringsAsFactors=FALSE)
crs(slk_sss)
plot(slk_sss, col='light blue', border='blue')

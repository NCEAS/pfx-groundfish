...
# working offline:
setwd("~/Google Drive/GoA project/pfx-groundfish/goaTrawl/Output Data")
...
# offline:
common <- read.csv(file = "trawl_species_control_file.csv", header = T, stringsAsFactors = F)
...
# offline:
shallowCPUEArea <- read.csv(file = "All_sp_index_meanCPUEByArea.Shallow.combined.MH.csv", header = T, stringsAsFactors = F)
#View(shallowCPUEArea)
...
# offline:
deepCPUEArea <- read.csv(file = "All_sp_index_meanCPUEByArea.Deep.MH.csv", header = T, stringsAsFactors = F)
#View(deepCPUEArea)

...
BootMean <- shallowDat %>%
            ...
            group_by(area, depth) %>%
            dplyr::summarise(CV_alpha = sd_alpha/Eff_Num_Sp,
...
names(cpueBootDiv)
ggplot(data = cpueBootDiv, aes(x = Sp_rich, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = Eff_Num_Sp, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = Exp_B_Div, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()
...
ggplot(data = cpueBootDiv, aes(x = Sp_rich, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = Eff_Num_Sp, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = Exp_B_Div, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()
...
ggplot(data = cpueBootDiv, aes(x = CV_spRich, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = CV_alpha, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = CV_beta, y = annCV, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()
...
ggplot(data = cpueBootDiv, aes(x = CV_spRich, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = CV_alpha, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()


ggplot(data = cpueBootDiv, aes(x = CV_beta, y = annMean, colour = depth)) +
  geom_point(size = 4) +
  theme_bw()

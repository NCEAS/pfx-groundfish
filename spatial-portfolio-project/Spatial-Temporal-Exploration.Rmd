...
Div.Metrics <- read.csv("../DiversityMetrics.Shallow.Bootstrapped2.csv") # NB this should probably be   read.csv("../DiversityMetrics.Shallow.Bootstrapped.Final.csv")
Div.Metrics <- Div.Metrics[Div.Metrics$AREA!=10,]
Sp.Richness <- read.csv("../Sp.Richness.Shallow.Bootstrapped.csv") # NB should this be updated to reflect splitting area 7? or is it is Shallow.Bootstrapped.Final loaded above?
...
Div.Metrics <- read.csv("../DiversityMetrics.Deep.Bootstrapped2.csv") # NB this should probably be   read.csv("../DiversityMetrics.Deep.Bootstrapped.Final.csv")
Div.Metrics <- Div.Metrics[Div.Metrics$AREA!=6,]
Sp.Richness <- read.csv("../Sp.Richness.Deep.Bootstrapped.csv") # NB should this be updated to reflect adjustments to area definitions? (ie cutting the tail off area 12?)  or is it is Deep.Bootstrapped.Final loaded above?

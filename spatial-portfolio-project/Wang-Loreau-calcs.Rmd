...
save(CV_Area_randomAgg, file = "CV_Area_randomAgg_3Apr.RData")
...
# Calculate cumulative Species Richness vs Area
...
Richness_Area_func <- function(my_df, spatialGrouping){
  ...
  my_df <- as.data.frame(matrix(unlist(df_list), nrow=length(unlist(df_list[1]))))
  colnames(my_df) <- c("speciesRichness")
  my_df <- mutate(my_df, id = rownames(my_df)) # add column with unique number
...
# run function for spatially nested aggregations of local communities:
richness_spatNested <- Richness_Area_func(occDat1, spatially_nested_list_noSingles)


# run function for random aggregations of local communities:
richness_randomAgg <- Richness_Area_func(occDat1, random_agg_list_noSingles)
#save(richness_randomAgg, file = "richness_randomAgg.RData")
#load("richness_randomAgg.RData")
...
save(sync_within_randomAgg, file = "sync_within_randomAgg_3Apr.RData")
...
save(sync_between_randomAgg, file = "sync_between_randomAgg_3Apr.RData")
#load("sync_between_randomAgg.RData")
...
save(avSpVar_within_randomAgg, file = "avSpVar_within_randomAgg_3Apr.RData")
#load("avSpVar_within_randomAgg.RData")
...
save(brayResult_randomAgg, file = "brayResult_randomAgg_3Apr.RData")
#load("brayResult_randomAgg.RData")
...
# 1. Spatially Nested Aggregations:
...
#summary(lm(spatNested$CV ~ spatNested$grossSyncWithin))
...
SN_SpRich_Area_plot <- ggplot(data=spatNested, aes(x=Area, y = speciesRichness, color = n, shape = n)) + 
  geom_point(size=5, show.legend = FALSE) +
  theme(panel.background = element_blank(),
        axis.line.x = element_line(color="black"),
        axis.line.y = element_line(color="black"),
...
SN_CV_SpRich <- ggplot(data=spatNested, aes(x=speciesRichness, y = CV, color = n, shape = n)) + 
  geom_point(size=5, show.legend = FALSE) +
  theme(panel.background = element_blank(),
        axis.line.x = element_line(color="black"),
        axis.line.y = element_line(color="black"),
...
SN_GrossAsynWithin_SpRich <- ggplot(data=spatNested, aes(x=speciesRichness, y = grossSyncWithin, color = n, shape = n)) + 
...
SN_GrossAsynBetween_SpRich <- ggplot(data=spatNested, aes(x=speciesRichness, y = grossSyncBetween, color = n, shape = n)) + 
  geom_point(size=3, show.legend = F) +
  theme_1_noLegend() +
  scale_y_reverse() +
  geom_smooth(method = lm, se = F, size = 0.75) +
...
SN_avSpVar_SpRich <- ggplot(data=spatNested, aes(x=speciesRichness, y = avSpVar, color = n, shape = n)) + 
  geom_point(size=3, show.legend = F) +
  theme_1_noLegend() +
  geom_smooth(method = lm, se = F, size = 0.75) +
  scale_color_manual(values = colorsN, limits = catN) +
...
SN_Bray_SpRich <- ggplot(data=spatNested, aes(x=speciesRichness, y = bray, color = n, shape = n)) + 
  geom_point(size=3, show.legend = F) +
  theme_1_noLegend() +
  geom_smooth(method = lm, se = F, size = 0.75) +
  scale_color_manual(values = colorsN, limits = catN) +
...
# 2. Random draws of local communities:
...
# Cumulative Species Richness vs Area:
RA_SpRich_Area_plot <- ggplot(data=randomAgg, aes(x=Area, y = speciesRichness, color = n, shape = n)) + 
  geom_point(size=3, show.legend = FALSE) +
  theme(panel.background = element_blank(),
        axis.line.x = element_line(color="black"),
        axis.line.y = element_line(color="black"),
...
# Cumulative Species Richness vs CV:
RA_CV_SpRich <- ggplot(data=randomAgg, aes(x=speciesRichness, y = CV, color = n, shape = n)) + 
  geom_point(size=3, show.legend = FALSE) +
  theme(panel.background = element_blank(),
        axis.line.x = element_line(color="black"),
        axis.line.y = element_line(color="black"),
...
# *** See also plots for Loreau & Thibaut metrics of synchrony
RA_GrossAsynWithin_SpRich <- ggplot(data=randomAgg, aes(x=speciesRichness, y = grossSyncWithin, color = n, shape = n)) + 
...
RA_GrossAsynBetween_SpRich <- ggplot(data=randomAgg, aes(x=speciesRichness, y = grossSyncBetween, color = n, shape = n)) + 
  geom_point(size=2, show.legend = F) +
  theme_1_noLegend() +
  scale_y_reverse() +
  geom_smooth(method = lm, se = F, size = 0.75) +
...
RA_avSpVar_SpRich <- ggplot(data=randomAgg, aes(x=speciesRichness, y = avSpVar, color = n, shape = n)) + 
  geom_point(size=2, show.legend = F) +
  theme_1_noLegend() +
  geom_smooth(method = lm, se = F, size = 0.75) +
  scale_color_manual(values = colorsN, limits = catN) +
...
RA_Bray_SpRich <- ggplot(data=randomAgg, aes(x=speciesRichness, y = bray, color = n, shape = n)) + 
  geom_point(size=2, show.legend = F) +
  theme_1_noLegend() +
  geom_smooth(method = lm, se = F, size = 0.75) +
  scale_color_manual(values = colorsN, limits = catN) +
...
# CV vs synchrony between local communities
...
# CV vs average species variation (within patches)

...
# Create spatial groupings for shallow communities:
...
# regional asynchrony between sites (species- and community-level)
...
cvLoreau_within <- ggplot(data=sync_within, aes(x=loreauSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
  ...
  labs(x = "Loreau Synchrony
       (Within-patch, between species)",
       y = "CV")



cvGross_within <- ggplot(data=sync_within, aes(x=grossSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
  ...
  labs(x = "Gross Synchrony
       (Within-patch, between species)",
       y = "CV")



cvThibaut_within <- ggplot(data=sync_within, aes(x=thibautSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
...
cvLoreau_between <- ggplot(data=sync_between, aes(x=loreauSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
...
cvGross_between <- ggplot(data=sync_between, aes(x=grossSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
...
cvThibaut_between <- ggplot(data=sync_between, aes(x=thibautSync, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
...
# plot average species variation (within patches) vs synchrony

cv_AvSpVar_within <- ggplot(data=avSpVar_within, aes(x=avSpVar, y = CV)) + 
  geom_point(aes(y = CV), size=5) +
  ...
  labs(x = "Averge Species Variability
       (Within-Patch)",
       y = "CV")
...
CV_bray_plot <- ggplot(data=brayResult, aes(x=bray, y = CV)) + 
  geom_point(aes(y = CV), size=5) +

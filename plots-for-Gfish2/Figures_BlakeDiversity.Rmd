...
# making final figure
 div_plot2c_final <- div_plot2c + labs(title="a.") + theme(axis.title.x = element_blank(), 
                                                           axis.text.x = element_blank())
 div_plot2_final <- div_plot3c + labs(title="b.") 
 
 div_plot3_final <- div_plot4d + labs(title="c.")     
# div_plot3a_final <- div_plot3a + labs(title="d.")   
# div_plot4c_final <- div_plot4c + labs(title="e.")
# 
 ffig2 <- ggarrange(div_plot2c_final, div_plot2_final, div_plot3_final, ncol=2, nrow=2)
# 
 ffig2

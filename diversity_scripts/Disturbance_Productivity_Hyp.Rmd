...
model1 <- gam(Sp_rich~s(met_ton_km2, k=3), data=dist_df, family=gaussian) 

#assumes normally distributed data 
model2 <- gam(Sp_rich~s(met_ton_km2, k=30), data=dist_df, family=gaussian) 

#assumes normally distributed data
model3 <- gam(Sp_rich~s(met_ton_km2, k=40), data=dist_df, family=gaussian) 

#assumes normally distributed data
model4 <- gam(Sp_rich~s(met_ton_km2, k=45), data=dist_df, family=gaussian) 

model3
model4
plot(model3, pages=1, residuals=TRUE)
plot(model4, pages=1, residuals=TRUE)

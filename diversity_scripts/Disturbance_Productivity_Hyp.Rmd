...
div_plot1 <- ggplot(dist_df_cat_ar, aes(y=met_ton_km2_ca, x=Sp_rich_ca)) + geom_point() +
             ...
             labs(title=paste("Adj R2 =",signif(summary(lmfit1)$adj.r.squared, 5),
...
div_plot2 <- ggplot(dist_df_cat_ar, aes(y=met_ton_km2_ca, x=Eff_Num_Sp_ca)) + geom_point() +
             stat_smooth(method="lm", col="blue") + 
             labs(title=paste("Adj R2 =",signif(summary(lmfit2)$adj.r.squared, 5),
...
div_plot3 <- ggplot(dist_df_cat_ar, aes(y=met_ton_km2_ca, x=Exp_B_Div_ca)) + geom_point() +
             stat_smooth(method="lm", col="blue") + 
             labs(title=paste("Adj R2 =",signif(summary(lmfit3)$adj.r.squared, 5),

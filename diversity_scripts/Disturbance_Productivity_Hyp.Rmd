...
# ggplot
gam1_plot <- ggplot(data=dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Sp_rich_ca, color=Catch_area)) + geom_point() +
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + ylab("Species Richness") +
             xlab("Fishing Pressure (metric tonnes km-2)") + theme(legend.position = "top") 
#gam1_plot
...
gam2_plot <- ggplot(data=dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Eff_Num_Sp_ca, color=Catch_area)) + 
             geom_point() +  ylab("Alpha Diversity") + xlab("Fishing Pressure (metric tonnes km-2)") + 
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + theme(legend.position = "top") 
...
# The ggplot:
gam3_plota <- ggplot(smooths3, aes(x, smooth)) + 
              geom_line() + theme_boxplot() +
              geom_line(aes(y=lower), linetype="dashed") + 
              geom_line(aes(y=upper), linetype="dashed") #+
...
gam3_plot <- ggplot(data=dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Exp_B_Div_ca, color=Catch_area)) + 
             geom_point() +  ylab("Beta Diversity") + xlab("Fishing Pressure (metric tonnes km-2)") + 
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + theme(legend.position = "top") 
...
div_plot2c <- ggplot(prod_chl_yr, aes(x=chl_mg_m3_mn, y=Sp_rich_mn, color=as.factor(area))) + geom_point() +
              stat_smooth(method="lm", col="blue") + ylab("Species Richness") +
...
div_plot3c <- ggplot(prod_chl_yr, aes(x=chl_mg_m3_mn, y=Eff_Num_Sp_mn, color=as.factor(area))) + geom_point() +
              stat_smooth(method="lm", col="blue") + ylab("Effective # of Species") +
              xlab("Primary Productivity (chla mg m^3)") + 
              theme(legend.position = "right") +
...
div_plot4c <- ggplot(prod_chl_yr, aes(x=chl_mg_m3_mn, y=Exp_B_Div_mn, color=as.factor(area))) + geom_point() +
              stat_smooth(method="lm", col="blue") + ylab("Beta Diversity") +
              xlab("Primary Productivity (chla mg m^3)") + 
              theme(legend.position = "right") +
...
# ggplot
gam4_plot <- ggplot(data=prod_chl_yr, aes(x=chl_mg_m3_mn, y=Sp_rich_mn, color=as.factor(area))) + geom_point() +
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + ylab("Species Richness") +
             xlab("Primary Productivity (chla mg m^3)") + theme(legend.position = "right") 
#gam4_plot
...
gam5_plot <- ggplot(data=prod_chl_yr, aes(x=chl_mg_m3_mn, y=Eff_Num_Sp_mn, color=as.factor(area))) + 
             geom_point() +
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + ylab("Alpha Diversity") +
             xlab("Primary Productivity (chla mg m^3)") + theme(legend.position = "right") 
#gam5_plot
...
gam6_plot <- ggplot(data=prod_chl_yr, aes(x=chl_mg_m3_mn, y=Exp_B_Div_mn, color=as.factor(area))) + 
             geom_point() +
             stat_smooth(method="gam", formula=y ~ s(x, k=4), col="red") + ylab("Beta Diversity") +
             xlab("Primary Productivity (chla mg m^3)") + theme(legend.position = "right") 
#gam6_plot

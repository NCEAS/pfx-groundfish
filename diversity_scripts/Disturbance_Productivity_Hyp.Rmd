...
div_plot1 <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Sp_rich_ca)) + geom_point() +
...
div_plot2 <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Eff_Num_Sp_ca)) + geom_point() +
...
div_plot3 <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Exp_B_Div_ca)) + geom_point() +
...
###with Loess fits
```{r, echo=FALSE, fig.height=9, fig.width=10}
div_plotA <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Sp_rich_ca)) + geom_point() +
             stat_smooth(method="loess", col="blue") + ylab("Species Richness") + 
             xlab("Fishing Pressure (metric tonnes km-2)")

div_plotB <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Eff_Num_Sp_ca)) + geom_point() +
             stat_smooth(method="loess", col="blue") + ylab("Effective # of Species") +
             xlab("Fishing Pressure (metric tonnes km-2)") 

div_plotC <- ggplot(dist_df_cat_ar, aes(x=met_ton_km2_ca, y=Exp_B_Div_ca)) + geom_point() +

...
#options(respos = c(getOption("repos"), INLA="https://www.math.ntnu.no/inla/R/testing"))
...
######## Region 11: East of Shelikof Strait
trim.x	<- c(-25,150)
trim.y	<- c(5967,6035)
x.lim	<-	c(-200,200)
y.lim	<-	c(5850,6150)
...
######## Region 13 - Outershelf off Kodiak
trim.x	<- c(-200,45)
trim.y	<- c(5867,5930)
x.lim	<-	c(-250,250)
y.lim	<-	c(5550,6000)
...
write.csv(dat.region,"Deep_goa_discrete_areas_for_comparison_150_to_300m.final.csv")



######## STOP

######## Region 17 - Outershelf off Kodiak (Long strip) -- Do not include
trim.x	<- c(-200,45)
trim.y	<- c(5600,5860)
x.lim	<-	c(-250,250)
y.lim	<-	c(5550,6000)

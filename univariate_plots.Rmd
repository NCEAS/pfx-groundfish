...
The *vplot* function will generate a figure for each year and area. Input a dataframe containing the species of interest, subsets of the "All_sp_index_meanCPUEByArea.csv"" file. 
...
ggplot(c, aes(year, Mean.totalDensity, group=Area, color=Area))+geom_line()+
  ...
  ylim(min(c$lci), max(c$uci))+ scale_x_continuous(limits=c(1984, 2012), breaks=seq(1984,2012,2))
}
```
